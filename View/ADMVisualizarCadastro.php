...
<body>
    ...
    $usuario = new Usuario();
    $usuario->carregarUsuarioID($_SESSION['idusuario']);
    ?>
    ...
    <div class="w3-padding-128 w3-content w3-text-grey">
        <div class="w3-container">
            ...
            <h2 class="w3-text-white w3-panel w3-cyan w3-round-large">
                DATA DE NASCIMENTO: <?php echo $usuario->getDataNascimento(); ?>
            </h2>
        </div>
    </div>
    <br>
                    ...
                    <thead>
                        ...
                        if ($results != null)
                            while ($row = $results->fetch_object()) {
                                ...
                                echo '<td style="width: 12%;">' . $row->fim . '</td>';
    ...
    <br>
    <div class="w3-padding-128 w3-content w3-text-grey">
        <form action="" method="post" class="w3-container w3-light-grey w3-text-blue w3-margin w3-center" style="width: 30%;">
            <div class="w3-row w3-section">
                ...
                <div>
                    <button name="btnImprimir" onClick="window.print()" class="w3-button w3-block w3-margin w3-blue w3-cell w3-round-large" style="width: 90%;">
                        Imprimir
                    </button>
                </div>
            </div>
